...
const ItemContent: React.FC<itemContent> = ({ item }) => {
  ...
  return (
    ...
    <div className="  grid grid-cols-4 gap-4 justify-items-center border-b border-slate-500 py-2 items-center">
      ...
      <div className="flex flex-wrap">
        <p className="text-[14px] font-medium max-sm:mx-3 max-sm:text-[11px]">{item.priceG}đ</p>
      </div>
      <div>
      <SetQuantity
                    cartProduct={item}
      ...
      <div>
      <p className="text-[14px]  max-sm:text-[11px] font-medium">{money}đ</p>
      </div>
